...
NEG_PROMPT = """
ugly, tiling, disfigured, deformed, low quality, pixelated, blurry,
grains, grainy, text, watermark, signature, out of frame, disproportioned,
bad proportions, gross proportions, bad anatomy, body out of frame,
cropped, cut off, draft, extra hands, extra arms, extra legs, extra fingers,
extra limbs, long neck, mutation, mutilated, poorly drawn face, poorly drawn feet,
missing hands, missing arms, missing legs, missing fingers, fused fingers,
unnatural pose, low resolution, morbid, boring background, render, plain,
uncreative, unattractive, opaque, distorted details, details are low, oversaturated,
underexposed, overexposed, lowres, weird views, weird angles, low contrast,
ugly background, asymmetrical buildings, jpeg artifacts, weird colors, deformed structures,
disproportionate, mangled, asymmetric, double face, unbalanced body, lacking body,
fused hand, skewed eyes, surreal, cropped head, group of people, unnatural, unrealistic.
"""
